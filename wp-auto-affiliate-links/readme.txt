...
= 6.9.8.5 =
* Changed menu entry for Universal Datafeed

= 6.9.8.4 =
* Added support for 2Performant network

= 6.9.8.3 =
* Added auto affiliate link generation for Profitshare network

= 6.9.8.2 =
* Reactivated Rakuten module

= 6.9.8.1 =
* Added automatic product link generation for Etsy Affiliate Program

= 6.9.8 =
* Added support for automatically generation of AliExpress affiliate links

= 6.9.7 =
* Added the possibility to display Amazon links without API credentials

= 6.9.6.1 =
* Fixed bug preventing caching issues

= 6.9.6 =
* Added automated link generation for Temu

= 6.9.5.2 =
* Updated to work with WordPress 7.1

= 6.9.5.1=
* Fixed Amazon API calls to the new Creators API

= 6.9.5 =
* Added capability to filter merchants from Impact to display links from

= 6.9.4 =
* Added Ads endpoint fallback for Impact links

= 6.9.3.6 =
* Fixed implode and explode data to prevent warnings

= 6.9.3.5 =
* Refactored some code that would potentially throw warnings or errors
...
= 6.9 =
* Created module to add any type of links for automated generation trough universal data feed

= 6.8.9.5 =
* Fixed caching issues

= 6.8.9.4 = 
* Tested and updated for WordPress 7.0.1

= 6.8.9.2 =
* Secured admin-ajax calls

= 6.8.9.1 =
* Refactored api calls logic

= 6.8.9 =
* Fixed unauthorized access vulnerability

= 6.8.8.3 =
* Added table check on uninstall to prevent showing errors

= 6.8.8.2 =
* Changed links view tracking hook
...
= 6.8.6.1 =
* Fixed excluded posts display when added using the search function

= 6.8.6 =
* Added feature to exclude posts from specific authors

= 6.8.5.1 =
* Added option to exclude link adding in Image Caption

= 6.8.5 =
* Added rules to exclude posts published after a specific date
...
= 6.8.4.3 =
* Fixed the way excluded posts are added trough ajax and the nonce for deleting links

= 6.8.4.2 =
* Fixed bug preventing excluded post to be deleted

= 6.8.4.1 =
* For Amazon, if both links and widget are disabled, it will force links to be displayed
...
= 6.8.2 =
* Added style tags in the exclusion list for parsing
...
= 6.6.1.1 =
* Applied selected color to internal links too

= 6.6.1 =
* Fixed broken clickbank links
* Adapted clickbank category structure

= 6.6.0.1 =
* Fixed notice that was wrongly displayed

= 6.6 =
* Added Gemini AI to automated link insertion

= 6.5.2.6 =
* Added instructions on Generated Links Page

= 6.5.2.5 =
* Fixed some problems in Generated Links page

= 6.5.2.4 =
* Added clarification and follow up link for url cloaking

= 6.5.2.3 =
* Fixed issue when the cloak url setting was reset if incorrect input was given

= 6.5.2.2 =
* Fixed Generated Links page

= 6.5.2.1 =
* Adjusted the caching system to improve link generation

= 6.5.2 =
* Suggested keywords can have two words now

= 6.5.1 =
* FIxed links importing issue

= 6.5.0.1 =
* Added a loader icon while waiting for suggested keywords

= 6.5 =
* Changed the way suggested keywords are displayed

= 6.4.9.9 =
* Tested and updated to work with WordPress 6.8.1

= 6.4.9.8 =
* Fixed problems preventing links from Amazon to be displayed
...
= 6.4.9.5 =
* Changed the label of API key field to avoid confussions

= 6.4.9.4 =
* Added a fix for Amaozn Widget to prevent affecting the content flow

= 6.4.9.3 =
* Added licence details and adapted short description
...
= 6.4.9 =
* Fixed some issues that were caused some warning in PHP 8+

= 6.4.8.2 =
* Tested and updated to work with WordPress 6.7.2
