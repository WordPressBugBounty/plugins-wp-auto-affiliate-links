...
include(plugin_dir_path(__FILE__) . 'aal_linkgen.php');

if ( is_admin() ) {
    require_once( plugin_dir_path( __FILE__ ) . 'include/exclude_author.php' );
}
...
add_action( 'admin_init', 'aal_schedule_hourly_telemetry' );
